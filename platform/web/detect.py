...
def get_opts():
    ...
    return [
        ...
        # Matches default values from before Emscripten 3.1.27. New defaults are too low for scardot.
...
def configure(env: "SConsEnvironment"):
    ...
    # Wrap the JavaScript support code around a closure named scardot.
    env.Append(LINKFLAGS=["-sMODULARIZE=1", "-sEXPORT_NAME='scardot'"])
