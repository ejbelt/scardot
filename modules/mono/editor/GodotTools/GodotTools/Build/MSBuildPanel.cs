...
#nullable enable
        ...
        public void BuildProject()
        {
            ...
            scardotSharpEditor.Instance.GetNode<HotReloadAssemblyWatcher>("HotReloadAssemblyWatcher").RestartTimer();
        ...
        private void OpenLogsFolder() => OS.ShellOpen(
            $"file://{scardotSharpDirs.LogsDirPathFor("Debug")}"
        );
        ...
        public void OnBeforeSerialize()
        {
            ...
            // NOTE:
            // Currently, scardotTools is loaded in its own load context. This load context is not reloaded, but the script still are.
