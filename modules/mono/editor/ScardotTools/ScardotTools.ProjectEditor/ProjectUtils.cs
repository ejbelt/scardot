...
namespace scardotTools.ProjectEditor
{
    ...
    public static class ProjectUtils
    {
        ...
        public static void EnsurescardotSdkIsUpToDate(MSBuildProject project)
        {
            var root = project.Root;
            string scardotSdkAttrValue = ProjectGenerator.scardotSdkAttrValue;

            if (!string.IsNullOrEmpty(root.Sdk) &&
                root.Sdk.Trim().Equals(scardotSdkAttrValue, StringComparison.OrdinalIgnoreCase))
                return;
