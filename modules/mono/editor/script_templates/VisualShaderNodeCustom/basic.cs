...
public partial class VisualShaderNode_CLASS_ : _BASE_
{
    ...
    public override string _GetCode(scardot.Collections.Array<string> inputVars, scardot.Collections.Array<string> outputVars, Shader.Mode mode, VisualShader.Type type)
    {
        return "";
    }
}
