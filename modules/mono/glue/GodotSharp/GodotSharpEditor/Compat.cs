...
{
    /// <inheritdoc cref="CreateAction(string, UndoRedo.MergeMode, scardotObject, bool)"/>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public void CreateAction(string name, UndoRedo.MergeMode mergeMode, scardotObject customContext)
    {
