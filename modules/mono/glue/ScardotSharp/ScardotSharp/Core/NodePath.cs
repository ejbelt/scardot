...
namespace scardot
{
    ...
    {
        internal scardot_node_path.movable NativeValue;
        ...
        private NodePath(scardot_node_path nativeValueToOwn)
        {
            NativeValue = (scardot_node_path.movable)nativeValueToOwn;
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static NodePath CreateTakingOwnershipOfDisposableValue(scardot_node_path nativeValueToOwn)
        ...
        public NodePath(string path)
        {
            ...
            {
                NativeValue = (scardot_node_path.movable)NativeFuncs.scardotsharp_node_path_new_from_string(path);
                _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
            }
        }
        ...
        public override string ToString()
        {
            ...
            var src = (scardot_node_path)NativeValue;
            NativeFuncs.scardotsharp_node_path_as_string(out scardot_string dest, src);
            using (dest)
        ...
        {
            scardot_node_path propertyPath = default;
            var self = (scardot_node_path)NativeValue;
            NativeFuncs.scardotsharp_node_path_get_as_property_path(self, ref propertyPath);
        ...
        {
            var self = (scardot_node_path)NativeValue;
            NativeFuncs.scardotsharp_node_path_get_concatenated_names(self, out scardot_string names);
            using (names)
        ...
        {
            var self = (scardot_node_path)NativeValue;
            NativeFuncs.scardotsharp_node_path_get_concatenated_subnames(self, out scardot_string subNames);
            using (subNames)
        ...
        {
            var self = (scardot_node_path)NativeValue;
            NativeFuncs.scardotsharp_node_path_get_name(self, idx, out scardot_string name);
            using (name)
        ...
        {
            var self = (scardot_node_path)NativeValue;
            return NativeFuncs.scardotsharp_node_path_get_name_count(self);
        }
        ...
        {
            var self = (scardot_node_path)NativeValue;
            NativeFuncs.scardotsharp_node_path_get_subname(self, idx, out scardot_string subName);
            using (subName)
        ...
        {
            var self = (scardot_node_path)NativeValue;
            return NativeFuncs.scardotsharp_node_path_get_subname_count(self);
        }
        ...
        {
            var self = (scardot_node_path)NativeValue;
            return NativeFuncs.scardotsharp_node_path_is_absolute(self).ToBool();
        }
        ...
        public bool Equals([NotNullWhen(true)] NodePath? other)
        {
            if (other is null)
                return false;
            var self = (scardot_node_path)NativeValue;
            var otherNative = (scardot_node_path)other.NativeValue;
            return NativeFuncs.scardotsharp_node_path_equals(self, otherNative).ToBool();
        }
        ...
        {
            var self = (scardot_node_path)NativeValue;
            return NativeFuncs.scardotsharp_node_path_hash(self);
        }
    }
}
