...
namespace scardot
{
    ...
    public struct Color : IEquatable<Color>
    {
        ...
        /// format (each byte represents a color channel).
        /// ARGB is more compatible with DirectX, but not used much in scardot.
        /// </summary>
        ...
        /// format (each byte represents a color channel).
        /// RGBA is scardot's default and recommended format.
        /// </summary>
        ...
        {
            return NativeFuncs.scardotsharp_color_from_ok_hsl(hue, saturation, lightness, alpha);
        }
