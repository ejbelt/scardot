...
namespace scardot
{
    public partial class scardotObject : IDisposable
    {
        ...
        internal unsafe void ConstructAndInitialize(
            delegate* unmanaged<scardot_bool, IntPtr> nativeCtor,
        ...
        )
        {
            if (NativePtr == IntPtr.Zero)
            {
                ...
                NativePtr = nativeCtor(scardot_bool.True);
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (NativePtr != IntPtr.Zero)
            {
                IntPtr gcHandleToFree = NativeFuncs.scardotsharp_internal_object_get_associated_gchandle(NativePtr);
                ...
                if (_memoryOwn)
                {
                    NativeFuncs.scardotsharp_internal_refcounted_disposed(NativePtr, gcHandleToFree,
                        (!disposing).ToscardotBool());
                }
                else
                {
                    NativeFuncs.scardotsharp_internal_object_disposed(NativePtr, gcHandleToFree);
                }
        ...
        {
            NativeFuncs.scardotsharp_object_to_string(GetPtr(this), out scardot_string str);
            using (str)
        ...
        protected internal virtual bool SetscardotClassPropertyValue(in scardot_string_name name, in scardot_variant value)
        {
            return false;
        }
        ...
        /// <returns><see langword="true"/> if a property with the given name was found.</returns>
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        protected internal virtual bool GetscardotClassPropertyValue(in scardot_string_name name, out scardot_variant value)
        {
            value = default;
            return false;
        }
        ...
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        protected internal virtual void RaisescardotClassSignalCallbacks(in scardot_string_name signal,
        ...
        {
            var typeSelf = (scardot_string_name)type.NativeValue;
            var methodSelf = (scardot_string_name)method.NativeValue;
            IntPtr methodBind = NativeFuncs.scardotsharp_method_bind_get_method(typeSelf, methodSelf);
        ...
        internal static IntPtr ClassDB_get_method_with_compatibility(StringName type, StringName method, ulong hash)
        {
            var typeSelf = (scardot_string_name)type.NativeValue;
            var methodSelf = (scardot_string_name)method.NativeValue;
            IntPtr methodBind = NativeFuncs.scardotsharp_method_bind_get_method_with_compatibility(typeSelf, methodSelf, hash);
        ...
        internal static unsafe delegate* unmanaged<scardot_bool, IntPtr> ClassDB_get_constructor(StringName type)
        {
            // for some reason the '??' operator doesn't support 'delegate*'
            var typeSelf = (scardot_string_name)type.NativeValue;
            var nativeConstructor = NativeFuncs.scardotsharp_get_class_constructor(typeSelf);
