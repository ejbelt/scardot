...
public partial class VariantUtils
{
    ...
    {
        public static unsafe scardot_variant ToVariant(in T from) =>
            ToVariantCb != null ? ToVariantCb(from) : throw UnsupportedType<T>();

        public static unsafe T FromVariant(in scardot_variant variant) =>
            FromVariantCb != null ? FromVariantCb(variant) : throw UnsupportedType<T>();

        // ReSharper disable once StaticMemberInGenericType
        internal static unsafe delegate*<in T, scardot_variant> ToVariantCb;

        // ReSharper disable once StaticMemberInGenericType
        internal static unsafe delegate*<in scardot_variant, T> FromVariantCb;
    ...
    public static scardot_variant CreateFrom<[MustBeVariant] T>(in T from)
    {
        ...
        if (typeof(T) == typeof(Variant))
            return NativeFuncs.scardotsharp_variant_new_copy((scardot_variant)UnsafeAs<Variant>(from).NativeVar);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static T ConvertTo<[MustBeVariant] T>(in scardot_variant variant)
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
