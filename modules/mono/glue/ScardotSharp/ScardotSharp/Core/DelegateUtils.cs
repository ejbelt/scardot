...
namespace scardot
{
    internal static class DelegateUtils
    {
        ...
        internal static scardot_bool DelegateEquals(IntPtr delegateGCHandleA, IntPtr delegateGCHandleB)
        {
            try
            {
        ...
        [UnmanagedCallersOnly]
        internal static unsafe int GetArgumentCount(IntPtr delegateGCHandle, scardot_bool* outIsValid)
        {
            try
            {
                var @delegate = (Delegate?)GCHandle.FromIntPtr(delegateGCHandle).Target;
                ...
                if (argCount is null)
                {
                    *outIsValid = scardot_bool.False;
                    return 0;
                }
                *outIsValid = scardot_bool.True;
        ...
        internal static unsafe void InvokeWithVariantArgs(IntPtr delegateGCHandle, void* trampoline,
            scardot_variant** args, int argc, scardot_variant* outRet)
        {
            try
            {
                if (trampoline == null)
                ...
                var @delegate = (Delegate)GCHandle.FromIntPtr(delegateGCHandle).Target!;
                var trampolineFn = (delegate* managed<object, NativeVariantPtrArgs, out scardot_variant, void>)trampoline;

                trampolineFn(@delegate, new NativeVariantPtrArgs(args, argc), out scardot_variant ret);
        ...
        private static bool TrySerializeSingleDelegate(Delegate @delegate, [MaybeNullWhen(false)] out byte[] buffer)
        {
            ...
            switch (target)
            {
                ...
                case scardotObject scardotObject:
                {
                    using (var stream = new MemoryStream())
                    using (var writer = new BinaryWriter(stream))
                    {
                        ...
                        writer.Write((ulong)scardotObject.GetInstanceId());
                    ...
                    if (targetType.IsDefined(typeof(CompilerGeneratedAttribute), true))
                    {
                        ...
                        using (var writer = new BinaryWriter(stream))
                        {
                            ...
                            foreach (FieldInfo field in fields)
                            {
                                ...
                                static byte[] VarToBytes(in scardot_variant var)
                                {
                                    NativeFuncs.scardotsharp_var_to_bytes(var, scardot_bool.True, out var varBytes);
                                    using (varBytes)
        ...
        [UnmanagedCallersOnly]
        internal static unsafe scardot_bool TrySerializeDelegateWithGCHandle(IntPtr delegateGCHandle,
            scardot_array* nSerializedData)
        {
            try
            {
                var serializedData = Collections.Array.CreateTakingOwnershipOfDisposableValue(
                    NativeFuncs.scardotsharp_array_new_copy(*nSerializedData));
        ...
        [UnmanagedCallersOnly]
        internal static unsafe scardot_bool TryDeserializeDelegateWithGCHandle(scardot_array* nSerializedData,
            ...
            using (var reader = new BinaryReader(stream))
            {
                ...
                switch (targetKind)
                {
                    ...
                    case TargetKind.scardotObject:
                    {
                        ...
                        scardotObject? scardotObject = scardotObject.InstanceFromId(objectId);
                        ...
                        @delegate = Delegate.CreateDelegate(delegateType, scardotObject, methodInfo,
                        ...
                        for (int i = 0; i < fieldCount; i++)
                        {
                            ...
                            if (fieldInfo != null)
                            {
                                ...
                                object? managedValue = RuntimeTypeConversionHelper.ConvertToObjectOfType(
                                    (scardot_variant)variantValue.NativeVar, fieldInfo.FieldType);
...
#pragma warning restore REFL045
        ...
        {
            public static scardot_variant ConvertToVariant(object? obj)
            {
                if (obj == null)
                    return default;
                ...
                switch (obj)
                {
                    ...
                    case scardotObject[] scardotObjectArray:
                        return VariantUtils.CreateFrom(scardotObjectArray);
                    ...
                    case Collections.Dictionary scardotDictionary:
                        return VariantUtils.CreateFrom(scardotDictionary);
                    case Collections.Array scardotArray:
                        return VariantUtils.CreateFrom(scardotArray);
                    case Variant variant:
                        return VariantUtils.CreateFrom(variant);
                    case scardotObject scardotObject:
                        return VariantUtils.CreateFrom(scardotObject);
                    case Enum @enum:
                        return VariantUtils.CreateFrom(Convert.ToInt64(@enum, CultureInfo.InvariantCulture));
                    case Collections.IGenericscardotDictionary scardotDictionary:
                        return VariantUtils.CreateFrom(scardotDictionary.UnderlyingDictionary);
                    case Collections.IGenericscardotArray scardotArray:
                        return VariantUtils.CreateFrom(scardotArray.UnderlyingArray);
                }
            ...
            private delegate object? ConvertToSystemObjectFunc(in scardot_variant managed);
            ...
            private static readonly System.Collections.Generic.Dictionary<Type, ConvertToSystemObjectFunc>
                ...
                {
                    [typeof(bool)] = (in scardot_variant variant) => VariantUtils.ConvertTo<bool>(variant),
                    [typeof(char)] = (in scardot_variant variant) => VariantUtils.ConvertTo<char>(variant),
                    [typeof(sbyte)] = (in scardot_variant variant) => VariantUtils.ConvertTo<sbyte>(variant),
                    [typeof(short)] = (in scardot_variant variant) => VariantUtils.ConvertTo<short>(variant),
                    [typeof(int)] = (in scardot_variant variant) => VariantUtils.ConvertTo<int>(variant),
                    [typeof(long)] = (in scardot_variant variant) => VariantUtils.ConvertTo<long>(variant),
                    [typeof(byte)] = (in scardot_variant variant) => VariantUtils.ConvertTo<byte>(variant),
                    [typeof(ushort)] = (in scardot_variant variant) => VariantUtils.ConvertTo<ushort>(variant),
                    [typeof(uint)] = (in scardot_variant variant) => VariantUtils.ConvertTo<uint>(variant),
                    [typeof(ulong)] = (in scardot_variant variant) => VariantUtils.ConvertTo<ulong>(variant),
                    [typeof(float)] = (in scardot_variant variant) => VariantUtils.ConvertTo<float>(variant),
                    [typeof(double)] = (in scardot_variant variant) => VariantUtils.ConvertTo<double>(variant),
                    [typeof(Vector2)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Vector2>(variant),
                    [typeof(Vector2I)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Vector2I>(variant),
                    [typeof(Rect2)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Rect2>(variant),
                    [typeof(Rect2I)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Rect2I>(variant),
                    [typeof(Transform2D)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Transform2D>(variant),
                    [typeof(Vector3)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Vector3>(variant),
                    [typeof(Vector3I)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Vector3I>(variant),
                    [typeof(Basis)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Basis>(variant),
                    [typeof(Quaternion)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Quaternion>(variant),
                    [typeof(Transform3D)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Transform3D>(variant),
                    [typeof(Vector4)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Vector4>(variant),
                    [typeof(Vector4I)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Vector4I>(variant),
                    [typeof(Aabb)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Aabb>(variant),
                    [typeof(Color)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Color>(variant),
                    [typeof(Plane)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Plane>(variant),
                    [typeof(Callable)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Callable>(variant),
                    [typeof(Signal)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Signal>(variant),
                    [typeof(string)] = (in scardot_variant variant) => VariantUtils.ConvertTo<string>(variant),
                    [typeof(byte[])] = (in scardot_variant variant) => VariantUtils.ConvertTo<byte[]>(variant),
                    [typeof(int[])] = (in scardot_variant variant) => VariantUtils.ConvertTo<int[]>(variant),
                    [typeof(long[])] = (in scardot_variant variant) => VariantUtils.ConvertTo<long[]>(variant),
                    [typeof(float[])] = (in scardot_variant variant) => VariantUtils.ConvertTo<float[]>(variant),
                    ...
                    [typeof(Color[])] = (in scardot_variant variant) => VariantUtils.ConvertTo<Color[]>(variant),
                    [typeof(StringName[])] =
                        (in scardot_variant variant) => VariantUtils.ConvertTo<StringName[]>(variant),
                    [typeof(NodePath[])] = (in scardot_variant variant) => VariantUtils.ConvertTo<NodePath[]>(variant),
                    [typeof(Rid[])] = (in scardot_variant variant) => VariantUtils.ConvertTo<Rid[]>(variant),
                    [typeof(StringName)] = (in scardot_variant variant) => VariantUtils.ConvertTo<StringName>(variant),
                    [typeof(NodePath)] = (in scardot_variant variant) => VariantUtils.ConvertTo<NodePath>(variant),
                    [typeof(Rid)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Rid>(variant),
                    [typeof(scardot.Collections.Dictionary)] = (in scardot_variant variant) =>
                        VariantUtils.ConvertTo<scardot.Collections.Dictionary>(variant),
                    [typeof(scardot.Collections.Array)] =
                        (in scardot_variant variant) => VariantUtils.ConvertTo<scardot.Collections.Array>(variant),
                    [typeof(Variant)] = (in scardot_variant variant) => VariantUtils.ConvertTo<Variant>(variant),
                };

            public static object? ConvertToObjectOfType(in scardot_variant variant, Type type)
            {
                ...
                if (typeof(scardotObject[]).IsAssignableFrom(type))
                {
                    static scardotObject[] ConvertToSystemArrayOfscardotObject(in scardot_array nativeArray, Type type)
                    {
                        var array = Collections.Array.CreateTakingOwnershipOfDisposableValue(
                            NativeFuncs.scardotsharp_array_new_copy(nativeArray));
                    ...
                    using var scardotArray = NativeFuncs.scardotsharp_variant_as_array(variant);
                    return ConvertToSystemArrayOfscardotObject(scardotArray, type);
                }
