...
namespace scardot
{
    ...
    public static partial class GD
    {
        ...
        public static Variant BytesToVar(Span<byte> bytes)
        {
            ...
            NativeFuncs.scardotsharp_bytes_to_var(varBytes, scardot_bool.False, out scardot_variant ret);
        ...
        {
            using var varBytes = Marshaling.ConvertSystemArrayToNativePackedByteArray(bytes);
            NativeFuncs.scardotsharp_bytes_to_var(varBytes, scardot_bool.True, out scardot_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        {
            NativeFuncs.scardotsharp_convert((scardot_variant)what.NativeVar, (int)type, out scardot_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        {
            return NativeFuncs.scardotsharp_hash((scardot_variant)var.NativeVar);
        }
        ...
        {
            using var scardotStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.scardotsharp_print(scardotStr);
        }
        ...
        {
            using var scardotStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.scardotsharp_print_rich(scardotStr);
        }
        ...
        {
            using var scardotStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.scardotsharp_printerr(scardotStr);
        }
        ...
        {
            using var scardotStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.scardotsharp_printraw(scardotStr);
        }
        ...
        public static void PrintS(params object[] what)
        {
            ...
            using var scardotStr = Marshaling.ConvertStringToNative(message);
            NativeFuncs.scardotsharp_prints(scardotStr);
        }
        ...
        public static void PrintT(params object[] what)
        {
            string message = AppendPrintParams('\t', what);
            using var scardotStr = Marshaling.ConvertStringToNative(message);
            NativeFuncs.scardotsharp_printt(scardotStr);
        }

        [StackTraceHidden]
        private static void ErrPrintError(string message, scardot_error_handler_type type = scardot_error_handler_type.ERR_HANDLER_ERROR)
        {
            ...
            using scardot_string messageStr = Marshaling.ConvertStringToNative(message);
            using scardot_string callerNameStr = Marshaling.ConvertStringToNative(callerName);
            using scardot_string callerFilePathStr = Marshaling.ConvertStringToNative(callerFilePath);
            NativeFuncs.scardotsharp_err_print_error(callerNameStr, callerFilePathStr, callerLineNumber, messageStr, p_type: type);
        }
        ...
        {
            ErrPrintError(message, type: scardot_error_handler_type.ERR_HANDLER_WARNING);
        }
        ...
        {
            ErrPrintError(AppendPrintParams(what), type: scardot_error_handler_type.ERR_HANDLER_WARNING);
        }
        ...
        {
            return NativeFuncs.scardotsharp_randf();
        }
        ...
        {
            return NativeFuncs.scardotsharp_randfn(mean, deviation);
        }
        ...
        {
            return NativeFuncs.scardotsharp_randi();
        }
        ...
        {
            NativeFuncs.scardotsharp_randomize();
        }
        ...
        {
            return NativeFuncs.scardotsharp_randf_range(from, to);
        }
        ...
        {
            return NativeFuncs.scardotsharp_randi_range(from, to);
        }
        ...
        {
            return NativeFuncs.scardotsharp_rand_from_seed(seed, out seed);
        }
        ...
        {
            NativeFuncs.scardotsharp_seed(seed);
        }
        ...
        {
            using var scardotStr = Marshaling.ConvertStringToNative(str);
            NativeFuncs.scardotsharp_str_to_var(scardotStr, out scardot_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        {
            NativeFuncs.scardotsharp_var_to_bytes((scardot_variant)var.NativeVar, scardot_bool.False, out var varBytes);
            using (varBytes)
        ...
        {
            NativeFuncs.scardotsharp_var_to_bytes((scardot_variant)var.NativeVar, scardot_bool.True, out var varBytes);
            using (varBytes)
                return Marshaling.ConvertNativePackedByteArrayToSystemArray(varBytes);
        }
        ...
        {
            NativeFuncs.scardotsharp_var_to_str((scardot_variant)var.NativeVar, out scardot_string ret);
            using (ret)
