...
namespace scardot
{
    public partial class scardotObject
    {
        ...
        {
            return InteropUtils.UnmanagedGetManaged(NativeFuncs.scardotsharp_instance_from_id(instanceId));
        }
        ...
        public static WeakRef? WeakRef(scardotObject? obj)
        {
            ...
            NativeFuncs.scardotsharp_weakref(GetPtr(obj), out scardot_ref weakRef);
            using (weakRef)
            {
                if (weakRef.IsNull)
                    return null;
