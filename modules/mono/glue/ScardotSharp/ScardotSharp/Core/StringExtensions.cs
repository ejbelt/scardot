...
namespace scardot
{
    ...
    public static class StringExtensions
    {
        ...
        {
            using scardot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.scardotsharp_string_to_camel_case(instanceStr, out scardot_string camelCase);
            using (camelCase)
        ...
        {
            using scardot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.scardotsharp_string_to_pascal_case(instanceStr, out scardot_string pascalCase);
            using (pascalCase)
        ...
        {
            using scardot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.scardotsharp_string_to_snake_case(instanceStr, out scardot_string snakeCase);
            using (snakeCase)
...
#pragma warning restore CA5350
        ...
        {
            using scardot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.scardotsharp_string_simplify_path(instanceStr, out scardot_string simplifiedPath);
