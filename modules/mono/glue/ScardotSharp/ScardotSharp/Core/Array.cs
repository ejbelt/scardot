...
#pragma warning restore CA1710
        ...
        IDisposable
    {
        internal scardot_array.movable NativeValue;
        ...
        public Array()
        {
            NativeValue = (scardot_array.movable)NativeFuncs.scardotsharp_array_new();
        ...
        private Array(scardot_array nativeValueToOwn)
        {
            NativeValue = (scardot_array.movable)(nativeValueToOwn.IsAllocated ?
                nativeValueToOwn :
                NativeFuncs.scardotsharp_array_new());
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static Array CreateTakingOwnershipOfDisposableValue(scardot_array nativeValueToOwn)
        ...
        {
            scardot_array newArray;
            var self = (scardot_array)NativeValue;
            NativeFuncs.scardotsharp_array_duplicate(ref self, deep.ToscardotBool(), out newArray);
        ...
        public void Fill(Variant value)
        {
            ...
            var self = (scardot_array)NativeValue;
            NativeFuncs.scardotsharp_array_fill(ref self, variantValue);
        }
        ...
        public Variant Max()
        {
            scardot_variant resVariant;
            var self = (scardot_array)NativeValue;
            NativeFuncs.scardotsharp_array_max(ref self, out resVariant);
        ...
        public Variant Min()
        {
            scardot_variant resVariant;
            var self = (scardot_array)NativeValue;
            NativeFuncs.scardotsharp_array_min(ref self, out resVariant);
            return Variant.CreateTakingOwnershipOfDisposableValue(resVariant);
        }
        ...
        public Variant PickRandom()
        {
            scardot_variant resVariant;
            var self = (scardot_array)NativeValue;
            NativeFuncs.scardotsharp_array_pick_random(ref self, out resVariant);
            return Variant.CreateTakingOwnershipOfDisposableValue(resVariant);
        }
        ...
        {
            var self = (scardot_array)NativeValue;
            var otherVariant = (scardot_array)other.NativeValue;
            return NativeFuncs.scardotsharp_array_recursive_equal(ref self, otherVariant).ToBool();
        }
        ...
        public Error Resize(int newSize)
        {
            ...
            var self = (scardot_array)NativeValue;
            return NativeFuncs.scardotsharp_array_resize(ref self, newSize);
        }
        ...
        public void Reverse()
        {
            ...
            var self = (scardot_array)NativeValue;
            NativeFuncs.scardotsharp_array_reverse(ref self);
        }
        ...
        public void Shuffle()
        {
            ...
            var self = (scardot_array)NativeValue;
            NativeFuncs.scardotsharp_array_shuffle(ref self);
        }
        ...
        public Array GetSliceRange(int start, int end, int step = 1, bool deep = false)
        {
            scardot_array newArray;
            var self = (scardot_array)NativeValue;
            NativeFuncs.scardotsharp_array_slice(ref self, start, end, step, deep.ToscardotBool(), out newArray);
            return CreateTakingOwnershipOfDisposableValue(newArray);
        }
        ...
        public void Sort()
        {
            ...
            var self = (scardot_array)NativeValue;
            NativeFuncs.scardotsharp_array_sort(ref self);
        }
        ...
        public unsafe Variant this[int index]
        {
            get
            {
                GetVariantBorrowElementAt(index, out scardot_variant borrowElem);
            ...
            set
            {
                ...
                var self = (scardot_array)NativeValue;
                scardot_variant* ptrw = NativeFuncs.scardotsharp_array_ptrw(ref self);
                scardot_variant* itemPtr = &ptrw[index];
                (*itemPtr).Dispose();
        ...
        public void Add(Variant item)
        {
            ...
            scardot_variant variantValue = (scardot_variant)item.NativeVar;
            var self = (scardot_array)NativeValue;
            _ = NativeFuncs.scardotsharp_array_add(ref self, variantValue);
        }
        ...
        public void AddRange<[MustBeVariant] T>(IEnumerable<T> collection)
        {
            ...
            {
                var self = (scardot_array)NativeValue;
                var collectionNative = (scardot_array)array.NativeValue;
                _ = NativeFuncs.scardotsharp_array_add_range(ref self, collectionNative);
                return;
            }
            if (collection is Array<T> typedArray)
            {
                var self = (scardot_array)NativeValue;
                var collectionNative = (scardot_array)typedArray.NativeValue;
                _ = NativeFuncs.scardotsharp_array_add_range(ref self, collectionNative);
                return;
            }
        ...
        public int BinarySearch(int index, int count, Variant item)
        {
            ...
            scardot_variant variantValue = (scardot_variant)item.NativeVar;
            var self = (scardot_array)NativeValue;
            return NativeFuncs.scardotsharp_array_binary_search(ref self, index, count, variantValue);
        }
        ...
        public int IndexOf(Variant item)
        {
            ...
            scardot_variant variantValue = (scardot_variant)item.NativeVar;
            var self = (scardot_array)NativeValue;
            return NativeFuncs.scardotsharp_array_index_of(ref self, variantValue);
        }
        ...
        public int IndexOf(Variant item, int index)
        {
            ...
            scardot_variant variantValue = (scardot_variant)item.NativeVar;
            var self = (scardot_array)NativeValue;
            return NativeFuncs.scardotsharp_array_index_of(ref self, variantValue, index);
        }
        ...
        public int LastIndexOf(Variant item)
        {
            ...
            scardot_variant variantValue = (scardot_variant)item.NativeVar;
            var self = (scardot_array)NativeValue;
            return NativeFuncs.scardotsharp_array_last_index_of(ref self, variantValue, Count - 1);
        }
        ...
        public int LastIndexOf(Variant item, int index)
        {
            ...
            scardot_variant variantValue = (scardot_variant)item.NativeVar;
            var self = (scardot_array)NativeValue;
            return NativeFuncs.scardotsharp_array_last_index_of(ref self, variantValue, index);
        }
        ...
        public void Insert(int index, Variant item)
        {
            ...
            scardot_variant variantValue = (scardot_variant)item.NativeVar;
            var self = (scardot_array)NativeValue;
            NativeFuncs.scardotsharp_array_insert(ref self, index, variantValue);
        }
        ...
        public void RemoveAt(int index)
        {
            ...
            var self = (scardot_array)NativeValue;
            NativeFuncs.scardotsharp_array_remove_at(ref self, index);
        }
        ...
        public void MakeReadOnly()
        {
            ...
            var self = (scardot_array)NativeValue;
            NativeFuncs.scardotsharp_array_make_read_only(ref self);
        }
        ...
        {
            var self = (scardot_array)NativeValue;
            NativeFuncs.scardotsharp_array_to_string(ref self, out scardot_string str);
            using (str)
        ...
        /// <paramref name="index"/> is less than 0 or greater than the array's size.
        /// </exception>
        internal void GetVariantBorrowElementAt(int index, out scardot_variant elem)
        {
            if (index < 0 || index >= Count)
                throw new ArgumentOutOfRangeException(nameof(index));
        ...
        /// The variant returned via the <paramref name="elem"/> parameter is owned by the Array and must not be disposed.
        /// </summary>
        internal unsafe void GetVariantBorrowElementAtUnchecked(int index, out scardot_variant elem)
        {
    ...
    {
        private static scardot_variant ToVariantFunc(in Array<T> scardotArray) =>
            VariantUtils.CreateFromArray(scardotArray);

        private static Array<T> FromVariantFunc(in scardot_variant variant) =>
        ...
        internal ref scardot_array.movable NativeValue
        {
        ...
        // Explicit name to make it very clear
        internal static Array<T> CreateTakingOwnershipOfDisposableValue(scardot_array nativeValueToOwn)
        ...
        public void Fill(T value)
        {
            ...
            scardot_variant variantValue = VariantUtils.CreateFrom(value);
            var self = (scardot_array)_underlyingArray.NativeValue;
            NativeFuncs.scardotsharp_array_fill(ref self, variantValue);
        }
        ...
        public unsafe T this[int index]
        {
            get
            {
                _underlyingArray.GetVariantBorrowElementAt(index, out scardot_variant borrowElem);
        ...
        public int IndexOf(T item, int index)
        {
            ...
            scardot_variant variantValue = VariantUtils.CreateFrom(item);
            var self = (scardot_array)_underlyingArray.NativeValue;
            return NativeFuncs.scardotsharp_array_index_of(ref self, variantValue, index);
        }
        ...
        public void AddRange(IEnumerable<T> collection)
        {
            ...
            {
                var self = (scardot_array)_underlyingArray.NativeValue;
                var collectionNative = (scardot_array)typedArray._underlyingArray.NativeValue;
                _ = NativeFuncs.scardotsharp_array_add_range(ref self, collectionNative);
                return;
            }
