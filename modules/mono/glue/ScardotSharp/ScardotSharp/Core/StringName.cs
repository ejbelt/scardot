...
namespace scardot
{
    ...
    {
        internal scardot_string_name.movable NativeValue;
        ...
        private StringName(scardot_string_name nativeValueToOwn)
        {
            NativeValue = (scardot_string_name.movable)nativeValueToOwn;
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static StringName CreateTakingOwnershipOfDisposableValue(scardot_string_name nativeValueToOwn)
        ...
        public StringName(string name)
        {
            ...
            {
                NativeValue = (scardot_string_name.movable)NativeFuncs.scardotsharp_string_name_new_from_string(name);
                _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
            }
        }
        ...
        public override string ToString()
        {
            ...
            var src = (scardot_string_name)NativeValue;
            NativeFuncs.scardotsharp_string_name_as_string(out scardot_string dest, src);
            using (dest)
        ...
        public static bool operator ==(StringName? left, in scardot_string_name right)
        {
            if (left is null)
        ...
        public static bool operator ==(in scardot_string_name left, StringName? right)
        {
            return right == left;
        }
        ...
        public bool Equals(in scardot_string_name other)
        {
