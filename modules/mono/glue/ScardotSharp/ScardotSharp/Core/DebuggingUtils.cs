...
#pragma warning disable IDE1006 // Naming rule violation
        ...
        internal ref struct scardot_stack_info
        {
            public scardot_string File;
            public scardot_string Func;
            public int Line;
        }

        // ReSharper disable once InconsistentNaming
        [StructLayout(LayoutKind.Sequential)]
        internal ref struct scardot_stack_info_vector
        {
            private IntPtr _writeProxy;
            private unsafe scardot_stack_info* _ptr;

            public readonly unsafe scardot_stack_info* Elements
            {
            ...
            public void Resize(int size)
            {
                ...
                var err = NativeFuncs.scardotsharp_stack_info_vector_resize(ref this, size);
                if (err != Error.Ok)
            ...
            public unsafe void Dispose()
            {
                if (_ptr == null)
                    return;
                NativeFuncs.scardotsharp_stack_info_vector_destroy(ref this);
                _ptr = null;
            }
        }
#pragma warning restore IDE1006
        ...
        internal static unsafe void GetCurrentStackInfo(void* destVector)
        {
            try
            {
                var vector = (scardot_stack_info_vector*)destVector;
                ...
                foreach (StackFrame frame in stackTrace.GetFrames())
                {
                    ...
                    scardot_stack_info* stackInfo = &vector->Elements[i];
