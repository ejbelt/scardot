...
public sealed class scardotSerializationInfo : IDisposable
{
    ...
    private scardotSerializationInfo(in scardot_dictionary properties, in scardot_dictionary signalEvents)
    {
    ...
    internal static scardotSerializationInfo CreateCopyingBorrowed(
        in scardot_dictionary properties, in scardot_dictionary signalEvents)
    {
        return new(NativeFuncs.scardotsharp_dictionary_new_copy(properties),
            NativeFuncs.scardotsharp_dictionary_new_copy(signalEvents));
    }
