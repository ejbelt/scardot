...
namespace scardot.Collections
{
    ...
    public sealed class Dictionary :
        ...
        IDisposable
    {
        internal scardot_dictionary.movable NativeValue;
        ...
        public Dictionary()
        {
            NativeValue = (scardot_dictionary.movable)NativeFuncs.scardotsharp_dictionary_new();
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        private Dictionary(scardot_dictionary nativeValueToOwn)
        {
            NativeValue = (scardot_dictionary.movable)(nativeValueToOwn.IsAllocated ?
                nativeValueToOwn :
                NativeFuncs.scardotsharp_dictionary_new());
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static Dictionary CreateTakingOwnershipOfDisposableValue(scardot_dictionary nativeValueToOwn)
        ...
        {
            scardot_dictionary newDictionary;
            var self = (scardot_dictionary)NativeValue;
            NativeFuncs.scardotsharp_dictionary_duplicate(ref self, deep.ToscardotBool(), out newDictionary);
        ...
        public void Merge(Dictionary dictionary, bool overwrite = false)
        {
            ...
            var self = (scardot_dictionary)NativeValue;
            var other = (scardot_dictionary)dictionary.NativeValue;
            NativeFuncs.scardotsharp_dictionary_merge(ref self, in other, overwrite.ToscardotBool());
        }
        ...
        {
            var self = (scardot_dictionary)NativeValue;
            var otherVariant = (scardot_dictionary)other.NativeValue;
            return NativeFuncs.scardotsharp_dictionary_recursive_equal(ref self, otherVariant).ToBool();
        }
        ...
        public ICollection<Variant> Keys
        {
            get
            {
                scardot_array keysArray;
                var self = (scardot_dictionary)NativeValue;
                NativeFuncs.scardotsharp_dictionary_keys(ref self, out keysArray);
        ...
        public ICollection<Variant> Values
        {
            get
            {
                scardot_array valuesArray;
                var self = (scardot_dictionary)NativeValue;
                NativeFuncs.scardotsharp_dictionary_values(ref self, out valuesArray);
        ...
        private (Array keys, Array values, int count) GetKeyValuePairs()
        {
            ...
            scardot_array valuesArray;
            NativeFuncs.scardotsharp_dictionary_keys(ref self, out valuesArray);
            var values = Array.CreateTakingOwnershipOfDisposableValue(valuesArray);

            int count = NativeFuncs.scardotsharp_dictionary_count(ref self);
        ...
        public Variant this[Variant key]
        {
            get
            {
                ...
                if (NativeFuncs.scardotsharp_dictionary_try_get_value(ref self,
                        (scardot_variant)key.NativeVar, out scardot_variant value).ToBool())
                {
            ...
            set
            {
                ...
                var self = (scardot_dictionary)NativeValue;
                NativeFuncs.scardotsharp_dictionary_set_value(ref self,
                    (scardot_variant)key.NativeVar, (scardot_variant)value.NativeVar);
            }
        }
        ...
        public void Add(Variant key, Variant value)
        {
            ...
            var variantKey = (scardot_variant)key.NativeVar;
            var self = (scardot_dictionary)NativeValue;

            if (NativeFuncs.scardotsharp_dictionary_contains_key(ref self, variantKey).ToBool())
                throw new ArgumentException("An element with the same key already exists.", nameof(key));

            scardot_variant variantValue = (scardot_variant)value.NativeVar;
            NativeFuncs.scardotsharp_dictionary_add(ref self, variantKey, variantValue);
        }
        ...
        public void Clear()
        {
            ...
            var self = (scardot_dictionary)NativeValue;
            NativeFuncs.scardotsharp_dictionary_clear(ref self);
        }
        ...
        {
            var self = (scardot_dictionary)NativeValue;
            return NativeFuncs.scardotsharp_dictionary_contains_key(ref self, (scardot_variant)key.NativeVar).ToBool();
        }

        bool ICollection<KeyValuePair<Variant, Variant>>.Contains(KeyValuePair<Variant, Variant> item)
        {
            scardot_variant variantKey = (scardot_variant)item.Key.NativeVar;
            var self = (scardot_dictionary)NativeValue;
            bool found = NativeFuncs.scardotsharp_dictionary_try_get_value(ref self,
                variantKey, out scardot_variant retValue).ToBool();
            ...
            using (retValue)
            {
                ...
                scardot_variant variantValue = (scardot_variant)item.Value.NativeVar;
                return NativeFuncs.scardotsharp_variant_equals(variantValue, retValue).ToBool();
            }
        }
        ...
        public bool Remove(Variant key)
        {
            ...
            var self = (scardot_dictionary)NativeValue;
            return NativeFuncs.scardotsharp_dictionary_remove_key(ref self, (scardot_variant)key.NativeVar).ToBool();
        }
        ...
        bool ICollection<KeyValuePair<Variant, Variant>>.Remove(KeyValuePair<Variant, Variant> item)
        {
            ...
            using (retValue)
            {
                ...
                scardot_variant variantValue = (scardot_variant)item.Value.NativeVar;
                if (NativeFuncs.scardotsharp_variant_equals(variantValue, retValue).ToBool())
                {
                    return NativeFuncs.scardotsharp_dictionary_remove_key(
        ...
        public int Count
        {
            ...
            {
                var self = (scardot_dictionary)NativeValue;
                return NativeFuncs.scardotsharp_dictionary_count(ref self);
            }
        }
        ...
        public void MakeReadOnly()
        {
            ...
            var self = (scardot_dictionary)NativeValue;
            NativeFuncs.scardotsharp_dictionary_make_read_only(ref self);
        }
        ...
        public bool TryGetValue(Variant key, out Variant value)
        {
            var self = (scardot_dictionary)NativeValue;
            bool found = NativeFuncs.scardotsharp_dictionary_try_get_value(ref self,
                (scardot_variant)key.NativeVar, out scardot_variant retValue).ToBool();
        ...
        {
            var self = (scardot_dictionary)NativeValue;
            NativeFuncs.scardotsharp_dictionary_key_value_pair_at(ref self, index,
                out scardot_variant key,
                out scardot_variant value);
        ...
        {
            var self = (scardot_dictionary)NativeValue;
            NativeFuncs.scardotsharp_dictionary_to_string(ref self, out scardot_string str);
            using (str)
    ...
    {
        private static scardot_variant ToVariantFunc(in Dictionary<TKey, TValue> scardotDictionary) =>
            VariantUtils.CreateFromDictionary(scardotDictionary);

        private static Dictionary<TKey, TValue> FromVariantFunc(in scardot_variant variant) =>
        ...
        internal ref scardot_dictionary.movable NativeValue
        {
        ...
        internal static Dictionary<TKey, TValue> CreateTakingOwnershipOfDisposableValue(
            scardot_dictionary nativeValueToOwn)
        ...
        public TValue this[TKey key]
        {
            get
            {
                ...
                var self = (scardot_dictionary)_underlyingDict.NativeValue;

                if (NativeFuncs.scardotsharp_dictionary_try_get_value(ref self,
                        variantKey, out scardot_variant value).ToBool())
                {
                    using (value)
        ...
        public ICollection<TKey> Keys
        {
            get
            {
                scardot_array keyArray;
                var self = (scardot_dictionary)_underlyingDict.NativeValue;
                NativeFuncs.scardotsharp_dictionary_keys(ref self, out keyArray);
        ...
        public bool ContainsKey(TKey key)
        {
            using var variantKey = VariantUtils.CreateFrom(key);
            var self = (scardot_dictionary)_underlyingDict.NativeValue;
            return NativeFuncs.scardotsharp_dictionary_contains_key(ref self, variantKey).ToBool();
        }
        ...
        public bool Remove(TKey key)
        {
            ...
            using var variantKey = VariantUtils.CreateFrom(key);
            var self = (scardot_dictionary)_underlyingDict.NativeValue;
            return NativeFuncs.scardotsharp_dictionary_remove_key(ref self, variantKey).ToBool();
        }
