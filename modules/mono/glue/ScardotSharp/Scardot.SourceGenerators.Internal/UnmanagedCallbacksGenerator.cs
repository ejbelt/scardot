...
");
    ...
    private static bool IsscardotInteropStruct(ITypeSymbol type) =>
        _scardotInteropStructs.Contains(type.FullQualifiedNameOmitGlobal());
    ...
    private static readonly string[] _scardotInteropStructs =
    {
        "scardot.NativeInterop.scardot_ref",
        "scardot.NativeInterop.scardot_variant_call_error",
        "scardot.NativeInterop.scardot_variant",
        "scardot.NativeInterop.scardot_string",
        "scardot.NativeInterop.scardot_string_name",
        "scardot.NativeInterop.scardot_node_path",
        "scardot.NativeInterop.scardot_signal",
        "scardot.NativeInterop.scardot_callable",
        "scardot.NativeInterop.scardot_array",
        "scardot.NativeInterop.scardot_dictionary",
        "scardot.NativeInterop.scardot_packed_byte_array",
        "scardot.NativeInterop.scardot_packed_int32_array",
        "scardot.NativeInterop.scardot_packed_int64_array",
        "scardot.NativeInterop.scardot_packed_float32_array",
        "scardot.NativeInterop.scardot_packed_float64_array",
        "scardot.NativeInterop.scardot_packed_string_array",
        "scardot.NativeInterop.scardot_packed_vector2_array",
        "scardot.NativeInterop.scardot_packed_vector3_array",
        "scardot.NativeInterop.scardot_packed_vector4_array",
        "scardot.NativeInterop.scardot_packed_color_array",
    };
}
