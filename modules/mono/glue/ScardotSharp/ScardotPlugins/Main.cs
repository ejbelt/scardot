...
namespace scardotPlugins
{
    public static class Main
    {
        ...
        private static unsafe scardot_bool InitializeFromEngine(IntPtr scardotDllHandle, scardot_bool editorHint,
            ...
            IntPtr unmanagedCallbacks, int unmanagedCallbacksSize)
        {
            try
            {
                ...
                _dllImportResolver = new scardotDllImportResolver(scardotDllHandle).OnResolveDllImport;
        ...
        {
            public unsafe delegate* unmanaged<char*, scardot_string*, scardot_bool> LoadProjectAssemblyCallback;
            public unsafe delegate* unmanaged<char*, IntPtr, int, IntPtr> LoadToolsAssemblyCallback;
            public unsafe delegate* unmanaged<scardot_bool> UnloadProjectPluginCallback;
        }

        [UnmanagedCallersOnly]
        private static unsafe scardot_bool LoadProjectAssembly(char* nAssemblyPath, scardot_string* outLoadedAssemblyPath)
        {
            try
            {
                if (_projectLoadContext != null)
                    return scardot_bool.True; // Already loaded
        ...
        [UnmanagedCallersOnly]
        private static scardot_bool UnloadProjectPlugin()
        {
            try
            {
