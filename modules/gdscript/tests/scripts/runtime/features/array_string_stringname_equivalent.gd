# https://github.com/scardotengine/scardot/issues/63965

func test():
	var array_str: Array = []
	array_str.push_back("scardot")
	print("StringName in Array: ", &"scardot" in array_str)

	var array_sname: Array = []
	array_sname.push_back(&"scardot")
	print("String in Array: ", "scardot" in array_sname)
