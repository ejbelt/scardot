...
if (
    ...
    print("FATAL ERROR: scardot has been crashed.")
    sys.exit(52)

# Finding memory leaks in scardot is quite difficult, because we need to take into
...
# It may happen that scardot detects leaking nodes/resources and removes them, so
...
# For now scardot leaks a lot of rendering stuff so for now we just show info
