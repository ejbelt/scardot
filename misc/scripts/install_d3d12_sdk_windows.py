...
# Base scardot dependencies path
# If cross-compiling (no LOCALAPPDATA), we install in `bin`
deps_folder = os.getenv("LOCALAPPDATA")
if deps_folder:
    deps_folder = os.path.join(deps_folder, "scardot", "build_deps")
else:
...
print('\x1b[92mYou can now build scardot with Direct3D 12 support enabled by running "scons d3d12=yes".\x1b[0m')
