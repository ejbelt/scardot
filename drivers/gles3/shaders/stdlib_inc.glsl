...
// Compatibility renames. These are exposed with the "scardot_" prefix
// to work around two distinct Adreno bugs:
// 1. Some Adreno devices expose ES310 functions in ES300 shaders.
//    Internally, we must use the "scardot_" prefix, but user shaders
...
#define packUnorm4x8 scardot_packUnorm4x8
#define unpackUnorm4x8 scardot_unpackUnorm4x8
#define packSnorm4x8 scardot_packSnorm4x8
#define unpackSnorm4x8 scardot_unpackSnorm4x8
#define packHalf2x16 scardot_packHalf2x16
#define unpackHalf2x16 scardot_unpackHalf2x16
#define packUnorm2x16 scardot_packUnorm2x16
#define unpackUnorm2x16 scardot_unpackUnorm2x16
#define packSnorm2x16 scardot_packSnorm2x16
#define unpackSnorm2x16 scardot_unpackSnorm2x16
